...
const mapStateToProps = (state, ownProps) => {
    return {
        items: getItemsFromAction(state.sectionObras.header.images)
    }
}
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    componentWillMount: () => {
        dispatch(fetchImagesFromGallery('obras'));
    }
  }
}

const CarouselImageObrasContainer = connect(
  mapStateToProps,
  mapDispatchToProps
)(CarouselImageItems)
...
export default CarouselImageObrasContainer